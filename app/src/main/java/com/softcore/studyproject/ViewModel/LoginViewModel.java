...
public class LoginViewModel extends MainViewModel{
    ...
    MutableLiveData<CommanResorce<List<UserModel>>> _data;
    ...
    public LiveData<CommanResorce<List<UserModel>>> getloginInfo(String DbName,String username,String Password){
        CommanResorce<List<UserModel>> _new_data=new CommanResorce<>();
        _data=new MutableLiveData<>();
        repository.getlogindetails(DbName,username, Password, new Callback<List<UserModel>>() {
            @Override
